    ...
    <section id="hero" ref={heroRef} className="relative w-full overflow-hidden" style={{ minHeight: '100svh' }}>
      ...
      >
        ...
        >
          ...
          <p className="mt-2">
            מצאתי את הנוסחה המושלמת. הנחיה מגבשת, ייחודית עם אינספור רגעים של צחוק והתרגשות.
          </p>
        ...
        >
          <span style={{ fontSize: '11px', color: 'rgba(255,255,255,.3)', letterSpacing: '.12em', textTransform: 'uppercase' }}>גלול מטה</span>
          <motion.div
            animate={{ y: [0, 8, 0] }}
